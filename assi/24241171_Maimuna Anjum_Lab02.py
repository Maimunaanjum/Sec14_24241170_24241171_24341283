...
def draw_line(x1, y1, x2, y2):
    ...
    x1_z, y1_z = to_zone_0(zone, x1, y1)
    x2_z, y2_z = to_zone_0(zone, x2, y2)
...
class Catcher:
    ...
    def draw(self):
        ...
        glBegin(GL_POINTS)
        draw_line(self.x, self.y + self.height, self.x + self.width, self.y + self.height)
        draw_line(self.x, self.y + self.height, self.x + 30, self.y)
        draw_line(self.x + self.width, self.y + self.height, self.x + self.width - 30, self.y)
        draw_line(self.x + 30, self.y, self.x + self.width - 30, self.y)
        glEnd()
...
class Diamond:
    ...
    def draw(self):
        ...
        cx, cy = self.x, self.y
        glBegin(GL_POINTS)
        draw_line(cx, cy + 10, cx + 10, cy)
        draw_line(cx + 10, cy, cx, cy - 10)
        draw_line(cx, cy - 10, cx - 10, cy)
        draw_line(cx - 10, cy, cx, cy + 10)
        glEnd()
...
class Button:
    ...
    def draw_arrow(self):  
        ...
        draw_line(*left, *head_top)
        draw_line(*left, *head_bottom)
        glEnd()
    ...
    def draw_pause(self):  
        ...
        cx = self.x
        cy = self.y
        draw_line(cx - 5, cy + 10, cx - 5, cy - 10)
        draw_line(cx + 5, cy + 10, cx + 5, cy - 10)
        glEnd()
    ...
    def draw_play(self):  
        ...
        draw_line(*left_top, *tip)
        draw_line(*tip, *left_bottom)
        draw_line(*left_bottom, *left_top)
        glEnd()
    ...
    def draw_cross(self):  
        ...
        cx = self.x
        cy = self.y
        draw_line(cx - 10, cy + 10, cx + 10, cy - 10)
        draw_line(cx - 10, cy - 10, cx + 10, cy + 10)
        glEnd()
